...
The first method used to get the accuracy scores for the 3 ML Algorithms (Random Forest, K-Neighbors and Linear Regression) failed as it ended up displaying values for only "Linear Regression" leaving out the other 2 ML Algorithms. A different method was used to get the accuracy scores for the 3 ML Algorithms at different intervals.
